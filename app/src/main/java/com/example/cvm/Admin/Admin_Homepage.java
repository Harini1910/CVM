...
public class Admin_Homepage extends AppCompatActivity {
   ...
   public FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Notification=findViewById(R.id.admin_notification);
       ...
       // FirebaseUser user= FirebaseAuth.getInstance().getCurrentUser();
        ...
        Notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Admin_Homepage.this,AdminNotification.class);
    ...
    public void listitems(){
        ...
        ref2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot3)
            {
                ...
                adapter = new RecyclerAdapter_slots(Admin_Homepage.this, list,hospital_code);
                       ...
                       /* create_slot info = new create_slot(date,time_slot,patients);
                        ...
                        ref.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                ref.child("ref_key").setValue(refkey);
                                Toast.makeText(Admin_Homepage.this,"Slot added!",Toast.LENGTH_LONG).show();
