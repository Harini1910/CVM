...
class RecyclerAdapter_hospitals extends RecyclerView.Adapter<RecyclerAdapter_hospitals.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            location=position;
            Intent intent=new Intent(context, Hospital_slots.class);
            intent.putExtra("hospital_name",data.get(position).getHospital_name());
            intent.putExtra("hospital_address",data.get(position).getHospital_address());
            intent.putExtra("hospital_number",data.get(position).getHospital_number());
