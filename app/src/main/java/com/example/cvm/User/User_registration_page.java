...
public class User_registration_page extends AppCompatActivity {
    ...
    public void checkConnection(){
            ...
            if(Name.length()==0){
                ...
                final user_signup infoss=new user_signup(Names,User_Address,User_Age,Gender,Phone_number,Emails,unique_key,mAuths.getCurrentUser().getUid());

                mAuths.createUserWithEmailAndPassword(Emails, password)
                        .addOnCompleteListener(User_registration_page.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {

                                    FirebaseDatabase.getInstance().getReference("user_signup").child(mAuths.getCurrentUser().getUid())
                                            .setValue(infoss).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
